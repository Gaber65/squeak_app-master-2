...
centerkHeading(val) {
  return Container(
    ...
    child: Text(
      ...
      style: const TextStyle(
          fontSize: 24, fontFamily: 'bold', color: Colors.white),
    ),
  );
}
...
blackHeadingSmall(val) {
  return Text(
    val,
    style:
        const TextStyle(fontSize: 20, fontFamily: 'bold', color: Colors.black),
  );
}
...
greyBoldText(val) {
  return Text(
    val,
    style: const TextStyle(
        fontSize: 15, fontFamily: 'medium', color: Colors.black54),
  );
}
...
appcolorText(val) {
  return Text(
    val,
    style:
        const TextStyle(fontSize: 12, color: appColor2, fontFamily: 'medium'),
  );
}
...
colorText(val) {
  return Text(
    val,
    style: const TextStyle(fontSize: 12, color: appColor, fontFamily: 'medium'),
  );
}
