...
class UpdatePostClinicUseCase extends BaseUseCase<PostEntities, AddPostParameters> {
  BaseClinicRepo baseClinicRepo;
  UpdatePostClinicUseCase(this.baseClinicRepo);
  @override
  Future<Either<Failure, PostEntities>> call(
      AddPostParameters parameters) async {
    return await baseClinicRepo.updatePostClinic(parameters);
  }
}
