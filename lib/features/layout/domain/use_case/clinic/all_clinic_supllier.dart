...
class GetAllSupplierClinicUseCase extends BaseUseCase<AllClinicEntities, AllFollowClinicParameters> {
  BaseClinicRepo baseClinicRepo;

  GetAllSupplierClinicUseCase(this.baseClinicRepo);

  @override
  Future<Either<Failure, AllClinicEntities>> call(AllFollowClinicParameters parameters) async {
    return await baseClinicRepo.allClinicSupplier(parameters);
  }
}
