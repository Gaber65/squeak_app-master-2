...
class GetDoctorAppointmentsUseCase extends BaseUseCase<GetAppointmentsEntities, NoParameters> {
  final BaseAvailabilitiesRepository baseAppointmentsRepository;

  GetDoctorAppointmentsUseCase(this.baseAppointmentsRepository);

  @override
  Future<Either<Failure, GetAppointmentsEntities>> call(NoParameters parameters)async {
    return await baseAppointmentsRepository.getDoctorAppointments();
  }
}
